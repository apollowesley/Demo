...
from uline_risk.model.uline.other import MerchantRiskItem, MerchantRiskInfo
...
def get_all_merchant_risk_item(session, query_conditions, page=0, page_size=10, fetchone=False):
    ...
    risk_query = risk_query.join(MerchantRiskInfo, MerchantRiskInfo.id == MerchantRiskItem.merchant_risk_id)
    # 是否有风险
    if has_risk > -1:
