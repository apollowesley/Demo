...
from uline_risk.utils.wxpay import query_wx
from uline_risk.utils.wxpay.util import deal_with_wx_result
from uline_risk.utils import common
...
class WxQueryTestCase(testing.AsyncTestCase):
    ...
    def stest_upload_pictures_api(self):
        imgfile = '/Users/apple/code/uline/uline/static/\
                uploads/mch/idcard/100000070011/4d48e3ce27924f67ac833550ed9ba3ab.jpg'
        import os
        import hashlib
        md5info = hashlib.md5()
        with open(imgfile, 'rb') as f:
            ...
            files = [(
                        'media',
                        (os.path.basename(imgfile), file_content, query_wx.get_content_type(imgfile), file_headers)
                    )]
    ...
    def stest_green_plan_get_new_cs(self):
        query_args = {
            ...
            'shop_entrance_pic': "MZPUO0HONxwyvQafQt5EOK9ekt0x-V3HJfJMC-FeSc-vySuJD630AhQr_YU_\
                    nYDxnQ38PMaYU9dqRQS775YRdZ_S2iFsSuCpznqwBv0qcrI",
            'checkstand_pic': "MZPUO0HONxwyvQafQt5EOK9ekt0x-V3HJfJMC-FeSc-\
                    vySuJD630AhQr_YU_nYDxnQ38PMaYU9dqRQS775YRdZ_S2iFsSuCpznqwBv0qcrI",
            'business_license_pic': "MZPUO0HONxwyvQafQt5EOK9ekt0x-V3HJfJMC-FeSc-vySuJD630AhQr\
                    _YU_nYDxnQ38PMaYU9dqRQS775YRdZ_S2iFsSuCpznqwBv0qcrI",
            'indoor_pic': "MZPUO0HONxwyvQafQt5EOK9ekt0x-V3HJfJMC-FeSc-vySuJD630AhQr\
                    _YU__YU_nYDxnQ38PMaYU9dqRQS775YRdZ_S2iFsSuCpznqwBv0qcrI",
        }
        print(query_args['nonce_str'], len(query_args['nonce_str']))
        query_wx.query_wx_api_block(query_args, 'greenplangetnewcs', channel=10)
    ...
    def stest_modify_cs_profile(self):
        ...
        yield query_wx.modify_cs_profile(args, WXPAY_KEY, WX_PRIVATE_KEY, WX_PUB_KEY, WX_ROOT_CA)
