...
# 微信测试公私钥(0费率)
WX_0_PUB_KEY = cur_dir + '/local/cert/wx_dev_cert.pem'
WX_0_PRIVATE_KEY = cur_dir + '/local/cert/wx_dev_key.pem'
WX_0_ROOT_CA = cur_dir + '/local/cert/wx_rootca.pem'

# 微信测试公私钥(扫码支付／刷卡支付／公众账号支付)
WX_PUB_KEY = cur_dir + '/local/cert/wx_dev_cert.pem'
WX_PRIVATE_KEY = cur_dir + '/local/cert/wx_dev_key.pem'
WX_ROOT_CA = cur_dir + '/local/cert/wx_rootca.pem'
...
# 微信测试公私钥(APP支付)
WX_APP_PUB_KEY = cur_dir + '/local/cert/wx_dev_cert.pem'
WX_APP_PRIVATE_KEY = cur_dir + '/local/cert/wx_dev_key.pem'
WX_APP_ROOT_CA = cur_dir + '/local/cert/wx_rootca.pem'

# 支付宝测试商户号
ALI_APPID = '2016073100137176'
ALI_PID = '2088102169373866'
# 支付宝测试公私钥
ALI_PUB_KEY = cur_dir + '/local/cert/alipay_dev_pub.key'
ALI_PRIVATE_KEY = cur_dir + '/local/cert/alipay_dev_pri.key'
...
# 京东支付
JD_SERVER_ADDRESS = 'http://111.202.65.172/channel/service.do'
JD_MCH_ID = '22294531'
JD_PUB_KEY = cur_dir + '/dev/cert/jd_local_pub.key'
JD_PRIVATE_KEY = cur_dir + '/dev/cert/jd_local_pri.key'
JD_KEY = 'qJUsKpxeURRhK5/ZhXc90Q=="'
JD_PASSWORD = 'abcdefg123456789'

# 测试渠道商后台
DIST_LOGIN_URL = 'http://mch.stage.uline.cc/account/'
# 测试商户后台
MCH_LOGIN_URL = 'http://mch.stage.uline.cc/account/'
# 连锁商户后台
CHAIN_LOGIN_URL = 'http://mch.stage.uline.cc/account/'
...
# 京东退款地址
JD_REFUND_URL = 'http://api.stage.uline.cc/jdpay/refunds'
...
# ULINE API
ULINE_API_URL = 'http://0.0.0.0:9901'
