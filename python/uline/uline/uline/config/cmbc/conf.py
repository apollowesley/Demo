...
JD_MCH_ID = '22294531'
JD_PUB_KEY = cur_dir + '/dev/cert/jd_cmbc_pub.key'
JD_PRIVATE_KEY = cur_dir + '/dev/cert/jd_cmbc_pri.key'
JD_KEY = 'qJUsKpxeURRhK5/ZhXc90Q=="'
JD_PASSWORD = 'abcdefg123456789'

# 正式渠道商后台
DIST_LOGIN_URL = 'http://cms.cmbxm.mbcloud.com/account/'
# 正式商户后台
MCH_LOGIN_URL = 'http://cms.cmbxm.mbcloud.com/account/'
# 连锁商户后台
CHAIN_LOGIN_URL = 'http://cms.cmbxm.mbcloud.com/account/'
...
# 京东退款地址
JD_REFUND_URL = 'http://api.cmbxm.mbcloud.com/jdpay/refunds'
...
ALI_RISK_PUB_KEY = cur_dir + '/cmbc/cert/alipay_mapi_pub.key'
ALI_RISK_PRIVATE_KEY = cur_dir + '/cmbc/cert/alipay_mapi_pri.key'
RISK_SIGN_TYPE = 'RSA'

RISK_NOTIFY_EMAIL = 'zhengjian_xm@cmbchina.com'
