...
sqlalchemy_uline_db = 'postgresql+psycopg2://uline:uline2015@192.168.0.3:5432/uline'
sqlalchemy_uline_trade_db = 'postgresql+psycopg2://uline:uline2015@192.168.0.3:5432/uline_trade'
...
JD_MCH_ID = '22294531'
JD_PUB_KEY = cur_dir + '/dev/cert/jd_dev_pub.key'
JD_PRIVATE_KEY = cur_dir + '/dev/cert/jd_dev_pri.key'
...
# 微信退款地址
WEIXIN_REFUND_URL = 'http://zhifu.stage.uline.cc/wechat/refunds'
# 支付宝退款地址
ALIPAY_REFUND_URL = 'http://zhifu.stage.uline.cc/alipay/refunds'
# 京东退款地址
JD_REFUND_URL = 'http://zhifu.stage.uline.cc/jdpay/refunds'
...
# ULINE API
ULINE_API_URL = 'http://api2.stage.uline.cc'
...
PAYMENT_CACHE_CLEAR_URL = 'http://192.168.0.3:1709/cache?opt=delall'
