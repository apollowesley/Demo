...
ALI_RISK_SERVER_ADDRESS = ALI_SERVER_ADDRESS
ALI_RISK_APPID = ALI_APPID
ALI_RISK_PID = ALI_PID
ALI_RISK_PUB_KEY = cur_dir + '/spd/cert/alipay_mapi_pub.key'
ALI_RISK_PRIVATE_KEY = cur_dir + '/spd/cert/alipay_mapi_pri.key'
RISK_SIGN_TYPE = 'RSA'
