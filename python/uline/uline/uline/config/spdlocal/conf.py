...
sqlalchemy_uline_db = 'postgresql+psycopg2://ulinesa:Xm.u7!nebio2@127.0.0.1:5432/spd_uline'
sqlalchemy_uline_trade_db = 'postgresql+psycopg2://nbuline:Sz.t7@6ed!o2@127.0.0.1:5433/spd_uline_trade'
...
WX_PUB_KEY = cur_dir + '/spdlocal/cert/wx_prod_cert.pem'
WX_PRIVATE_KEY = cur_dir + '/spdlocal/cert/wx_prod_key.pem'
WX_ROOT_CA = cur_dir + '/spdlocal/cert/wx_rootca.pem'
...
# 正式微信公私钥(APP支付)
WX_APP_PUB_KEY = cur_dir + '/spdlocal/cert/wx_app_prod_cert.pem'
WX_APP_PRIVATE_KEY = cur_dir + '/spdlocal/cert/wx_app_prod_key.pem'
WX_APP_ROOT_CA = cur_dir + '/spdlocal/cert/wx_app_rootca.pem'
...
# 正式支付宝公私钥
ALI_PUB_KEY = cur_dir + '/spdlocal/cert/alipay_prod_pub.key'
ALI_PRIVATE_KEY = cur_dir + '/spdlocal/cert/alipay_prod_pri.key'
...
# 京东支付
JD_SERVER_ADDRESS = 'http://channel-info.jdpay.com/channel/service.do'
JD_MCH_ID = '110339775'
JD_PUB_KEY = cur_dir + '/spd/cert/jd_spd_pub.key'
JD_PRIVATE_KEY = cur_dir + '/spd/cert/jd_spd_pri.key'
JD_KEY = 'ntDsJ5Ij62+1o203eWTRiQ=='
JD_PASSWORD = '2fb06c8b69be2abe1ec19bb03c93497a'

# 正式渠道商后台
DIST_LOGIN_URL = 'http://cms.spd.uline.cc/account/'
# 正式商户后台
MCH_LOGIN_URL = 'http://cms.spd.uline.cc/account/'
# 正式连锁商户后台
CHAIN_LOGIN_URL = 'http://cms.spd.uline.cc/account/'
...
# 京东退款地址
JD_REFUND_URL = 'http://api.mch.spd.uline.cc/jdpay/refunds'
...
DEFAULT_BANK_ID = ""
PAYMENT_CACHE_CLEAR_URL = 'http://127.0.0.1:1709/cache?opt=delall'


ALI_RISK_SERVER_ADDRESS = "http://openapi.stable.dl.alipaydev.com/gateway.do"
ALI_RISK_APPID = '2017071201325188'
ALI_RISK_PID = 'xxxxxxxxxxxxxxxx'
ALI_RISK_PUB_KEY = cur_dir + '/local/cert/alipay_mapi_pub.key'
ALI_RISK_PRIVATE_KEY = cur_dir + '/local/cert/alipay_mapi_pri.key'
RISK_SIGN_TYPE = 'RSA'

RISK_NOTIFY_EMAIL = 'fuyy1@spdb.com.cn'

RISK_API_URL = 'http://127.0.0.1:8835'
