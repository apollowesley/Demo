    ...
    $.ajax({
        ...
        if (res.code == '200') {
            ...
            if(!$.isEmptyObject(role)){
                if(role.wx != null){
                    payHtml+='<div class="role-box col-md-12">微信支付D0提现手续费： '+role.wx+'</div>';
                }
                if(role.alipay != null){
                    payHtml+='<div class="role-box col-md-12">支 付 宝 D0提现手续费： '+role.alipay+'</div>';
                }
            }
