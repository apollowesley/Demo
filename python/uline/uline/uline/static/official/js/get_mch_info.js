    ...
    $.ajax({
        ...
        if (res.code == '200') {
            ...
            if(data.activated_status==2){
                appendAddressHtml = appendAddressHtml + "<span id='resend-email' onclick='resendActiveEmail("+value+");'>重新发送激活邮件</span></div>";
            }
            appendAddressHtml = appendAddressHtml + "</div>";
            ...
            appendMchInfoHtml = appendMchInfoHtml + "<div class='col-md-12 col-sm-12 list' id='base-resend'>";
            appendMchInfoHtml = appendMchInfoHtml + "<h4><label>基本信息</label>";
            var resendEmailBtn = "<span id='resend-email' onclick='resendActiveEmail();'>重新发送激活邮件</span>";
            //appendMchInfoHtml = appendMchInfoHtml + resendEmailBtn;
            appendMchInfoHtml = appendMchInfoHtml + "</h4>";
            ...
            appendMchInfoHtml = appendMchInfoHtml + "<div><label>支付宝经营类目</label><span>"+ data.ali_ind_name +"</span></div>";
...
function resendActiveEmail(mch_id){
    ...
    $.ajax({
        ...
        data: {"mch_id": mch_id},
        dataType: 'json',
        url: '/official/inlet/mch/resend_active_email'
    }).done(function(res){
        var code = res.code;
