...
$().ready(function () {
    ...
    if (document.getElementById('pagination')) {
        var params = "&create_at_start=" + create_at_start + "&create_at_end=" + create_at_end + "&mch_name=" +
            ...
            "&transaction_id=" + transaction_id + "&refund_status=" + refund_status
            + "&channel=" + channel + "&mch_id=" + mch_id + "&dt_id=" + dt_id + "&cs_mch_shortname=" + cs_mch_shortname + "&cs_mch_id=" + cs_mch_id;
