...
//     var v = document.getElementById("cmbProvince").value;
//     if (v == '教育/培训' || v == '医疗') {
//         $('#mch-app-config').hide();
//     } else {
//         $('#mch-app-config').show();
...
$().ready(function () {
    ...
    // setInterval('changeProvince()', 500);
...
//      上传图片反面
    ...
    // 点击使用appid时，显示协议条款
    $('#dt_wx_true').change(function(){
        if ($(this).is(':checked')){
            $('#wx_app_config').removeClass('hide');
            if (!$('#wx_app_checkbox').is(':checked')) {
    ...
    $('#wx_app_checkbox').change(function(){
        if ($(this).is(':checked')){
            $('#submit-btn').removeAttr('disabled');
        } else {
            $('#submit-btn').attr('disabled','disabled');
    ...
    // 点击不使用appid时，隐藏协议条款
    $('#dt_wx_false').change(function(){
        if ($(this).is(':checked')){
            $('#wx_app_config').addClass('hide');
            $('#submit-btn').removeAttr('disabled');
        };
    });
    if ($('#dt_wx_false').is(':checked')){
        $('#wx_app_config').addClass('hide');
        $('#submit-btn').removeAttr('disabled');
    };
});
