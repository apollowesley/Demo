...
class CsTransactionTradeListHandler(ChainAdminHandler):
    @tornado.web.authenticated
    @check_permission
    def prepare(self):
        form = MerchantTradeList(self)
        if not form.validate():
            self.redirect('/chain/transaction/trade/list')
            return
    ...
    def get(self):
        ...
        self.render('chain/transaction/csTradeList.html', data=data)
