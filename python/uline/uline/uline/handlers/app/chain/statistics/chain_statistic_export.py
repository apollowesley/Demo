...
from uline.backend.dist.generate_chain_transaction_stat_info import generate_xls
import tcelery
...
class ExportchainTransactionStatisticHandler(ChainAdminHandler):
    ...
    def db_transaction_stats(self):
        ...
        response = yield gen.Task(generate_xls.apply_async, args=[self.chain_id, create_at_start, create_at_end, query_date])
        ret = response.result
