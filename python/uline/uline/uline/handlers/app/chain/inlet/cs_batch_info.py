...
class CSBatchInletInfoHandler(ChainAdminHandler):
    ...
    def get(self):
        ...
        self.write(s_rsp)
        # self.render('chain/inlet/csInformation.html',
    ...
    def get_inlet_result_info(self):
        ...
        if inlet_data:
            ...
            data, total, valid_num = mch_info_fd[
                0], mch_info_fd[1], mch_info_fd[2]
