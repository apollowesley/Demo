...
class MerchantsTransactionTradeHandler(IntBkAdminHandler):
    ...
    def get(self):
        ...
        self.render('inter_bank/transaction/merchantTrade.html', navigate_html=navigate_html, data=data, form=self.form,
    ...
    def db_execute(self, form, offset):
        ...
        if dt_name or dt_id:
            ...
            dt_query = """select dt_user.dt_id from dt_user
