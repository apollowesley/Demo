...
from uline.handlers.app.inter_bank.risk.form import MerchantRiskSearchForm
from uline.utils.risk_api import risk_api_util
from uline.public.permit import check_permission


class MerchantRiskIndexHandler(IntBkAdminHandler):
    @web.authenticated
    @check_permission
    def prepare(self):
        ...
        self.render_url = 'inter_bank/risk/merchant_risk.html'
