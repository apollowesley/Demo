...
from uline.backend.inter_bank.generate_dist_inlet_info import generate_xls
import tcelery
...
class ExportDistributorHandler(IntBkAdminHandler):
    ...
    def db_inlet_info(self):
        ...
        dt_id = self.form.dt_id.data or 0
