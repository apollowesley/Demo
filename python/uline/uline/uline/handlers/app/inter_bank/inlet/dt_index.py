...
class DistributorInletIndexHandler(IntBkAdminHandler):
    ...
    def prepare(self):
        ...
        if not self.form.validate() and self.form.activated_status.data != None:
            self.redirect('/inter_bank/inlet/dt')
            return
    ...
    def get(self):
        ...
        self.render('inter_bank/inlet/distributor.html', navigate_html=navigate_html, data=self.data, form=self.form,
    ...
    def db_execute(self, form, offset):
        ...
        query = """SELECT dt.dt_id,
                        ...
                        where a2.dt_id= a1.dt_id and a2.create_at > a1.create_at)) as z
