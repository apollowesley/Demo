...
class ReconRefundErrorIndexHandler(BkAdminHandler):
    ...
    def prepare(self):
        ...
        if not self.form.validate():
            self.redirect('/bank/recon/refund')
            return
    ...
    def get(self):
        ...
        self.render('bank/reconciliation/refund.html', navigate_html=navigate_html, data=self.data, form=self.form,
