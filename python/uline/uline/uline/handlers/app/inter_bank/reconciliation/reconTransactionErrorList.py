...
class ReconTransactionErrorListHandler(BkAdminHandler):
    ...
    def prepare(self):
        ...
        if not form.validate():
            self.redirect('/bank/balance/transaction/list')
            return
    ...
    def get(self):
        ...
        self.render('bank/reconciliation/transactionList.html', recon_error_html=recon_error_html, data=data)
