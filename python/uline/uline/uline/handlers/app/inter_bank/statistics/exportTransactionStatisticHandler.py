...
from uline.backend.inter_bank.generate_transaction_stat_info import generate_xls
import tcelery
...
class ExportTransactionStatisticHandler(BkAdminHandler):
    ...
    def db_transaction_stats(self):
        ...
        response = yield gen.Task(generate_xls.apply_async, args=[bk_id, create_at_start, create_at_end, query_date])
        ret = response.result
