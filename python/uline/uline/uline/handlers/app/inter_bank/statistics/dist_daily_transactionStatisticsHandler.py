...
class DistDailyTransactionHandler(BkAdminHandler):
    ...
    def get(self):
        ...
        self.render('inter_bank/statistics/disttransactionStatistics.html', data=data, order_by_form=self.order_by,
