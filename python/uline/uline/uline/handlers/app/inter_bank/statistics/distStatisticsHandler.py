...
class DistStatisticsHandler(BkAdminHandler):
    ...
    def get(self):
        ...
        self.render('inter_bank/statistics/distStatistics.html', navigate_html=navigate_html, data=data, form=self.form, query_date=int(self.query_date),
