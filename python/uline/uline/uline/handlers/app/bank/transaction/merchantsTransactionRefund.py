...
class MerchantsTransactionRefundHandler(BkAdminHandler):
    ...
    def get(self):
        ...
        self.render('bank/transaction/merchantRefund.html', navigate_html=navigate_html, data=data, form=self.form,
