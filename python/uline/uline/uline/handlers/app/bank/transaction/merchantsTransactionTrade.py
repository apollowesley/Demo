...
class MerchantsTransactionTradeHandler(BkAdminHandler):
    ...
    def get(self):
        ...
        self.render('bank/transaction/merchantTrade.html', navigate_html=navigate_html, data=data, form=self.form,
