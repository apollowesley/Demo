...
class GetChainInfoHandler(BkAdminHandler):
    ...
    def get_inlet_and_balance(self, cursor):
        ...
        fields = [
            ...
            'license_period',
            'license_scope', 'license_img', 'parent_id', 'activated_status', 'dt_sub_id', 'activate_email_tag', 'bk_id',
            'bk_name', 'license_type', 'head_mobile', 'head_name', 'head_type'
        ]
