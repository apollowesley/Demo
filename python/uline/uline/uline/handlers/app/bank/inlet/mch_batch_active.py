...
class ActivatedBatchMerchantInletStatusHandler(BkAdminHandler):
...
广州优畅信息技术有限公司{5}
客服电话：4008047555""".format(self.mch_info[2] + ".mch", self.mch_info[1], self.mch_info[2], self.mch_info[3], MCH_LOGIN_URL,
                          addition_info)
            }
