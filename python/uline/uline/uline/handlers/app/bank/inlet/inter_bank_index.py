...
class InterBankInletIndexHandler(BkAdminHandler):
    ...
    def prepare(self):
        ...
        if not self.form.validate():
            self.redirect('/bank/inlet/inter_bank')
            return
    ...
    def get(self):
        ...
        self.render('bank/inlet/interBank.html', navigate_html=navigate_html, data=self.data, form=self.form,
