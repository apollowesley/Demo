...
from uline.backend.merchant.generate_transaction_stat_info import generate_xls
import tcelery
...
class ExportTransactionStatisticHandler(MchAdminHandler):
    ...
    def db_inlet_info(self):
        ...
        response = yield gen.Task(
            generate_xls.apply_async,
            args=[mch_id, create_at_start, create_at_end, query_date]
        )
        ret = response.result
