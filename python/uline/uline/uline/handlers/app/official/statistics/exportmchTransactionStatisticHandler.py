...
from uline.backend.official.generate_mch_transaction_stat_info import generate_xls
import tcelery
tcelery.setup_nonblocking_producer()
thread_num = cpu_count()


class ExportmchTransactionStatisticHandler(OfclAdminHandler):
    ...
    def db_transaction_stats(self):
        ...
        response = yield gen.Task(generate_xls.apply_async, args=[self.mch_id, create_at_start, create_at_end, query_date])
        ret = response.result
