...
class MchStatisticsHandler(OfclAdminHandler):
    ...
    def prepare(self):
        ...
        if int(self.query_date) == 1 and self.create_at_start and \
                len(self.create_at_start.split('-')) == 2:
            self.query_date = 2
    ...
    def get(self):
        ...
        self.render('official/statistics/mchStatistics.html', navigate_html=navigate_html, data=data, form=self.form, query_date=int(self.query_date),
