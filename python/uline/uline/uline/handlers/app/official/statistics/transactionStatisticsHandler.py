...
class TransactionStatisticsHandler(OfclAdminHandler):
    ...
    def get(self):
        ...
        self.render('official/statistics/transactionStatistics.html', data=data, query_date=int(self.query_date), order_by_form=self.order_by,
