...
class ChainStatisticsHandler(OfclAdminHandler):
    ...
    def get(self):
        ...
        self.render('official/statistics/chainStatistics.html', navigate_html=navigate_html, data=data, form=self.form,
