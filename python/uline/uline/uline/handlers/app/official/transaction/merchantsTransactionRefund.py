...
class MerchantsTransactionRefundHandler(OfclAdminHandler):
    ...
    def get(self):
        ...
        self.render('official/transaction/merchantRefund.html', navigate_html=navigate_html, data=data, form=self.form,
