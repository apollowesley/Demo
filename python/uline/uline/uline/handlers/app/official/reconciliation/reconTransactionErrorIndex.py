...
class ReconTransactionErrorIndexHandler(OfclAdminHandler):
    ...
    def prepare(self):
        ...
        if not self.form.validate():
            self.redirect('/official/recon/transaction')
            return
    ...
    def get(self):
        ...
        self.render('official/reconciliation/transaction.html', navigate_html=navigate_html, data=self.data,
