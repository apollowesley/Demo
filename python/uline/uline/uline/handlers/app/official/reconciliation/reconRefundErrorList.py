...
class ReconRefundErrorListHandler(OfclAdminHandler):
    ...
    def prepare(self):
        ...
        if not form.validate():
            self.redirect('/official/balance/refund/list')
            return
    ...
    def get(self):
        ...
        self.render('official/reconciliation/refundList.html', recon_error_html=recon_error_html, data=data)
