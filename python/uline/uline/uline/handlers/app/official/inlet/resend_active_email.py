...
class ResendMchActiveEmailHandler(OfclAdminHandler):
    ...
    def get_mch_info(self):
        query = """select mch_inlet_info.email, mch_inlet_info.mch_name, mch_user.mch_id, mch_user.mch_pay_key,
                    mch_inlet_info.cs_id, mch_inlet_info.activate_email_tag,
