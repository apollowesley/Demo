...
class DistributorBalanceListHandler(OfclAdminHandler):
    ...
    def prepare(self):
        ...
        if not form.validate():
            self.redirect('/official/balance/dt/list')
            return
    ...
    def get(self):
        ...
        self.render('official/balance/distributorBalanceList.html', data=data)
