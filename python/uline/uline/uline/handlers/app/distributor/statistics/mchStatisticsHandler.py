...
class MchStatisticsHandler(DtAdminHandler):
    ...
    def get(self):
        ...
        self.render('distributor/statistics/mchStatistics.html', navigate_html=navigate_html, data=data, form=self.form, query_date=int(self.query_date),
