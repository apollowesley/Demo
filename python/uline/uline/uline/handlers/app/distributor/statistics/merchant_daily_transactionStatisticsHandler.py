...
class MchDailyTransactionHandler(DtAdminHandler):
    ...
    def get(self):
        ...
        self.render('distributor/statistics/mchtransactionStatistics.html', data=data, order_by_form=self.order_by, query_date=int(self.query_date),
