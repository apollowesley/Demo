...
class MerchantsTransactionTradeListHandler(DtAdminHandler):
    ...
    def prepare(self):
        ...
        if not form.validate():
            self.redirect('/dist/transaction/trade/list')
            return
    ...
    def get(self):
        ...
        self.render('distributor/transaction/merchantTradeList.html', data=data)
    ...
    def do_execute(self):
        ...
        ul_fields = ['mch_name', 'mch_shortname', 'dt_name']
