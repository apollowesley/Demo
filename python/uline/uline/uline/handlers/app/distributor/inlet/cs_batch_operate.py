...
class CSBatchInletOperateHandler(DtAdminHandler):
        ...
        for payment_type in PAY_TYPES:
            ...
            if payment_rate >= 0:
                ...
                self.db.executeSQL(
                    ...
                    """,
                    (
                        self.mch_id, str(self.dt_id), int(payment_rate), data.get('uline_payment_id'),
