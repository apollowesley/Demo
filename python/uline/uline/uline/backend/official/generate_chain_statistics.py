...
def db_statistics_info(dt_name, dt_id, chain_name, chain_id, create_at_start, order_by):
    ...
    _query = """SELECT dii.dt_name, dii.dt_id,
    ...
    data = db.selectSQL(_query,
                        {"create_at_start": create_at_start,
                         ...
                         "dt_name": db.escape(dt_name), "dt_id": db.escape(dt_id),
                         'chain_id': db.escape(chain_id), "chain_name": db.escape(chain_name)},
                        fetchone=False)
