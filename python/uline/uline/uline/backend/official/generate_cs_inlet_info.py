...
def generate_xls(user_id, chain_name, cs_name, cs_id, chain_id, create_at_start, create_at_end, activated_status,
    ...
    try:
        inlet_info_data = db_inlet_info(chain_name, cs_name, cs_id, chain_id, create_at_start, create_at_end,
...
def db_inlet_info(chain_name, cs_name, cs_id, chain_id, create_at_start, create_at_end, activated_status, auth_status):
    query = """
        SELECT s.* from (
            SELECT
