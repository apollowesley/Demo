...
@app.task
def generate_xls(user_id, dt_name, dt_id, create_at_start, create_at_end, pay_status, total_num, channel, balance_account, expand_type, bk_id, bk_name):
    ...
    try:
        inlet_info_data = db_inlet_info(
            dt_name, dt_id, create_at_start, create_at_end, pay_status, channel, balance_account, expand_type, bk_id, bk_name)
...
def db_inlet_info(dt_name, dt_id, create_at_start, create_at_end, pay_status, channel, balance_account, expand_type, bk_id, bk_name):
    query = """select
