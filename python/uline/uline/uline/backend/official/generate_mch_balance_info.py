...
@app.task
def generate_xls(user_id, dt_name, mch_name, dt_id, mch_id, create_at_start, create_at_end, pay_status, total_num,
                 channel, balance_account, cs_mch_shortname, cs_mch_id, expand_type, bk_id, bk_name):
    ...
    try:
        inlet_info_data = db_inlet_info(dt_name, mch_name, dt_id, mch_id,
                                        create_at_start, create_at_end, pay_status, channel, balance_account, cs_mch_shortname, cs_mch_id, expand_type, bk_id, bk_name)
...
def db_inlet_info(dt_name, mch_name, dt_id, mch_id, create_at_start, create_at_end, pay_status, channel, balance_account, cs_mch_shortname, cs_mch_id, expand_type, bk_id, bk_name):
    query = """select
    ...
    query_dict = {
        ...
        'bk_id': db.escape(bk_id),
        'bk_name': db.escape(bk_name)
    }
