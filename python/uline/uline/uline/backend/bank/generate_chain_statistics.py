...
@app.task
def generate_xls(user_id, dt_name, dt_id, chain_name, chain_id, create_at_start, create_at_end, order_by, total_num):
    wb = Workbook()
    ...
    try:
        ...
        mch_statistics_data = db_statistics_info(dt_name, dt_id, chain_name, chain_id, create_at_start, create_at_end,
                                                 order_by)
...
def db_statistics_info(dt_name, dt_id, chain_name, chain_id, create_at_start, create_at_end, order_by):
    _query = """SELECT SELECT dii.dt_name, dii.dt_id,
