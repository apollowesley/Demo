...
@app.task
def generate_xls(user_id, dt_name, dt_id, mch_name, mch_id, create_at_start, create_at_end, order_by, total_num, expand_type, bk_id, bk_name):
    wb = Workbook()
    ...
    try:
        ...
        mch_statistics_data = db_statistics_info(dt_name, dt_id, mch_name, mch_id, create_at_start, create_at_end,
                                                 order_by, expand_type, bk_id, bk_name)
...
def db_statistics_info(dt_name, dt_id, mch_name, mch_id, create_at_start, create_at_end, order_by, expand_type, bk_id, bk_name):
