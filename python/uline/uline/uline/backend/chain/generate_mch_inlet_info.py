...
def gen_inlet_info(ws, datas, industry_name):
    fields = [u'门店编号', u'门店简称', u'门店名称', u'微信门店编号', u'省份', u'城市', u'联系地址', u'联系人', u'联系电话',
    ...
    for data in datas:
        data = list(data)
        data[10], data[11], data[17] = BALANCE_WAY[str(data[10])], BALANCE_TYPE[str(data[11])], AUTH_STATUS[
            str(data[17])]
...
def gen_mch_payment_info(ws, datas):
    if not datas:
        return
    fields = [u'门店名称', u'支付类型', u'结算费率(‰)', u'激活状态']
    ws.append(fields)
