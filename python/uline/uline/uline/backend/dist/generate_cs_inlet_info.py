...
# 生成商户进件信息
@app.task
def generate_xls(user_id, cs_name, short_name, cs_id, mch_id, create_at_start, create_at_end, activated_status,
    ...
    try:
        inlet_info_data = db_inlet_info(cs_name, short_name, cs_id, mch_id, create_at_start, create_at_end,
                                        activated_status, auth_status, user_id)
...
def db_inlet_info(cs_name, short_name, cs_id, mch_id, create_at_start, create_at_end, activated_status, auth_status, user_id):
    query = """
        SELECT s.* from (
          SELECT
            ...
            WHERE (mch_inlet_info.activated_status=%(activated_status)s OR %(activated_status)s IS NULL )
              ...
              and (dt_user.dt_id=%(dt_boss_id)s)
