...
@app.task
def generate_xls(user_id, dt_name, dt_id, mch_name, mch_id, create_at_start, create_at_end, order_by, total_num):
    wb = Workbook()
    ...
    try:
        ...
        mch_statistics_data = db_statistics_info(user_id, dt_name, dt_id, mch_name, mch_id, create_at_start, create_at_end,
                                                 order_by)
...
def db_statistics_info(user_id, dt_name, dt_id, mch_name, mch_id, create_at_start, create_at_end, order_by):
