...
def generate_xls(user_id, dt_name, mch_name, dt_id, mch_id, complete_at_start, complete_at_end,
    ...
    try:
        ...
        inlet_info_data = db_inlet_info(user_id, dt_name, mch_name, dt_id, mch_id, complete_at_start, complete_at_end,
...
def db_inlet_info(user_id, dt_name, mch_name, dt_id, mch_id, complete_at_start, complete_at_end,
                  out_trade_no, mch_trade_no, wx_transaction_id,
                  trade_state, trade_type, channel, cs_mch_shortname, cs_mch_id):
    data = []
    ul_query = """select
