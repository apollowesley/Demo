...
def get_industry_code():
    ...
    for industry_uline in industry_ulines:
        industry_code[industry_uline.industry_code] = industry_uline.new_ali_ind_code
...
def update_industry_code():
    ...
    for mchinletinto, mch_user in mchinletintos:
        with uline_session_scope()as session:
            new_ali_ind_code = code_dict.get(mchinletinto.u_ind_code)
            if mchinletinto.ali_ind_code != new_ali_ind_code:
                mchinletinto.ali_ind_code = new_ali_ind_code
