...
if env == 'DEV':
    from uline_api.config.dev.conf import *
elif env == 'LOCAL':
    from uline_api.config.local.conf import *
elif env == 'CMBC_PROD':
    # 招商银行
    from uline_api.config.cmbc.conf import *
elif env == 'SPD_PROD':
    # 浦发银行
    from uline_api.config.spd.conf import *
elif env == 'SPDLOCAL':
    # 浦发银行
    from uline_api.config.spdlocal.conf import *
elif env == 'DEV3':
    from uline_api.config.dev3.conf import *
else:
