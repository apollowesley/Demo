package com.kyl.ps.infrastructure.service.impl.feedback;
...
public class FeedbackManagerServiceImpl {
	...
	@Autowired
	FeedbackManagerDao feedbackManagerDao;

	public List<Map<String,Object>> getFeedbackInfoList(BaseInputMessage inMessage) {
		return feedbackManagerDao.getFeedbackInfoList(FeedbackManagerDao.class,inMessage);
	}

	public Map<String,Object> getFeedbackInfo(BaseInputMessage inMessage) {
		return feedbackManagerDao.getFeedbackInfo(FeedbackManagerDao.class,inMessage);
	}

	public int replyFeedbackInfo(BaseInputMessage inMessage) {
		return feedbackManagerDao.replyFeedbackInfo(FeedbackManagerDao.class,inMessage);
	}

	public Map<String,Object> getFeedbackInfoPageCount(BaseInputMessage inMessage) {
		return feedbackManagerDao.getFeedbackInfoPageCount(FeedbackManagerDao.class,inMessage);
	}
/**
